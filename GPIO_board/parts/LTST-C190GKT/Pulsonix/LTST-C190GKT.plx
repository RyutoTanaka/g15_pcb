...
(library Library_1
	...
	(patternDef "LEDC1608X90N" (originalName "LEDC1608X90N")
		(multiLayer
	...
	(symbolDef "LTST-C190GKT" (originalName "LTST-C190GKT")
	...
	(compDef "LTST-C190GKT" (originalName "LTST-C190GKT") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LTST-C190GKT"))
		(attachedPattern (patternNum 1) (patternName "LEDC1608X90N")
			(numPads 2)
			(padPinMap
		...
		(attr "Mouser Part Number" "859-LTST-C190GKT")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Lite-On/LTST-C190GKT?qs=drxkyCeiWgbQzclgbojDOg%3D%3D")
		(attr "Manufacturer_Name" "Lite-On")
		(attr "Manufacturer_Part_Number" "LTST-C190GKT")
		(attr "Description" "Standard LEDs - SMD Green Clear 569nm")
		(attr "<Hyperlink>" "https://media.digikey.com/pdf/Data%20Sheets/Lite-On%20PDFs/LTST-C190GKT.pdf")
		(attr "<Component Height>" "0.9")
		(attr "<STEP Filename>" "LTST-C190GKT.stp")
		(attr "<STEP Offsets>" "X=-0.02;Y=0;Z=0.14")
